export interface MilestoneItem {
  ...
  requiredDocs?: string[];
  tips?: string[];
  states?: string[]; // if set, only show to users in these states (full state name)
...
export const MILESTONES: MilestoneItem[] = [
  ...
  {
    key: "ca_medi_cal",
    title: "Apply for Medi-Cal (California Medicaid)",
    description: "California offers Medi-Cal free health coverage to eligible immigrants regardless of immigration status. Children and pregnant individuals qualify regardless of status.",
    urgency: "urgent",
    week: 2,
    category: "health",
    officialLink: "https://www.dhcs.ca.gov/services/medi-cal/Pages/DoYouQualifyForMedi-Cal.aspx",
    states: ["California"],
    tips: ["Apply online at coveredca.com or at your county social services office", "Children 0–18 qualify regardless of immigration status", "Undocumented adults who had coverage before Jan 1 2026 can keep it — new enrollments are restricted", "Medi-Cal is NOT counted in the public charge test — it will not affect your immigration case", "Call (800) 541-5555 for help in multiple languages"],
    translations: {
      es: { title: "Solicitar Medi-Cal (Medicaid de California)", description: "California ofrece cobertura médica gratuita de Medi-Cal a inmigrantes elegibles sin importar su estatus migratorio.", tips: ["Solicita en coveredca.com o en la oficina de servicios sociales de tu condado", "Los niños de 0 a 18 años califican sin importar su estatus migratorio", "Los adultos indocumentados con cobertura antes del 1 de enero de 2026 pueden mantenerla", "Medi-Cal NO cuenta en la prueba de carga pública", "Llama al (800) 541-5555 para ayuda en varios idiomas"] },
      zh: { title: "申请Medi-Cal（加州医疗补助）", description: "加州为符合条件的移民提供免费Medi-Cal医疗保险，无论移民身份如何。", tips: ["在coveredca.com或县社会服务办公室申请", "0-18岁儿童无论移民身份均符合条件", "2026年1月1日前已有保险的无证件成年人可继续保留", "Medi-Cal不计入公共负担测试", "拨打(800)541-5555获取多语言帮助"] },
      hi: { title: "Medi-Cal के लिए आवेदन करें (कैलिफोर्निया मेडिकेड)", description: "कैलिफोर्निया आव्रजन स्थिति की परवाह किए बिना पात्र अप्रवासियों को मुफ्त Medi-Cal स्वास्थ्य बीमा प्रदान करता है।", tips: ["coveredca.com या अपने काउंटी कार्यालय में आवेदन करें", "0-18 वर्ष के बच्चे स्थिति की परवाह किए बिना योग्य हैं", "जनवरी 2026 से पहले कवरेज वाले वयस्क इसे बनाए रख सकते हैं", "Medi-Cal सार्वजनिक भार परीक्षण में नहीं गिना जाता", "कई भाषाओं में सहायता के लिए (800) 541-5555 पर कॉल करें"] },
      ar: { title: "التقدم للحصول على Medi-Cal (ميديكيد كاليفورنيا)", description: "تقدم كاليفورنيا تغطية صحية مجانية من Medi-Cal للمهاجرين المؤهلين بغض النظر عن وضعهم الهجري.", tips: ["تقدم بطلبك على coveredca.com أو في مكتب الخدمات الاجتماعية بمقاطعتك", "الأطفال من 0 إلى 18 عاماً مؤهلون بغض النظر عن الوضع الهجري", "البالغون غير الموثقين الذين كانت لديهم تغطية قبل 1 يناير 2026 يمكنهم الاحتفاظ بها", "Medi-Cal لا يُحتسب في اختبار العبء العام", "اتصل بـ (800) 541-5555 للحصول على مساعدة بلغات متعددة"] },
      fr: { title: "Faire une demande de Medi-Cal (Medicaid de Californie)", description: "La Californie offre une couverture santé gratuite Medi-Cal aux immigrants éligibles quel que soit leur statut migratoire.", tips: ["Faites une demande sur coveredca.com ou au bureau des services sociaux de votre comté", "Les enfants de 0 à 18 ans sont éligibles quel que soit leur statut", "Le Medi-Cal n'est pas pris en compte dans le test de charge publique", "Appelez le (800) 541-5555 pour une aide en plusieurs langues"] },
      pt: { title: "Solicitar Medi-Cal (Medicaid da Califórnia)", description: "A Califórnia oferece cobertura de saúde gratuita Medi-Cal para imigrantes elegíveis independentemente do status migratório.", tips: ["Solicite em coveredca.com ou no escritório de serviços sociais do seu condado", "Crianças de 0 a 18 anos se qualificam independentemente do status", "O Medi-Cal não é contado no teste de carga pública", "Ligue para (800) 541-5555 para ajuda em vários idiomas"] },
      vi: { title: "Đăng Ký Medi-Cal (Medicaid California)", description: "California cung cấp bảo hiểm y tế miễn phí Medi-Cal cho người nhập cư đủ điều kiện bất kể tình trạng di trú.", tips: ["Đăng ký tại coveredca.com hoặc văn phòng dịch vụ xã hội quận", "Trẻ em 0–18 tuổi đủ điều kiện bất kể tình trạng di trú", "Medi-Cal không được tính trong bài kiểm tra gánh nặng công", "Gọi (800) 541-5555 để được hỗ trợ bằng nhiều ngôn ngữ"] },
      ko: { title: "Medi-Cal 신청 (캘리포니아 메디케이드)", description: "캘리포니아는 이민 신분에 관계없이 자격을 갖춘 이민자에게 무료 Medi-Cal 건강 보험을 제공합니다.", tips: ["coveredca.com 또는 카운티 사회 서비스 사무소에서 신청하세요", "0~18세 어린이는 이민 신분에 관계없이 자격이 됩니다", "Medi-Cal은 공공 부담 테스트에 포함되지 않습니다", "다국어 지원을 위해 (800) 541-5555로 전화하세요"] },
      tl: { title: "Mag-apply para sa Medi-Cal (California Medicaid)", description: "Nag-aalok ang California ng libreng health coverage ng Medi-Cal sa mga karapat-dapat na imigrante anuman ang immigration status.", tips: ["Mag-apply sa coveredca.com o sa iyong county social services office", "Ang mga bata 0–18 ay karapat-dapat anuman ang immigration status", "Ang Medi-Cal ay hindi binibilang sa public charge test", "Tumawag sa (800) 541-5555 para sa tulong sa maraming wika"] },
    },
  },
  {
    key: "ca_calfresh",
    title: "Apply for CalFresh (California Food Assistance)",
    description: "California's CalFresh provides food assistance to eligible immigrants. The California Food Assistance Program (CFAP) also covers immigrants ineligible for federal SNAP.",
    urgency: "recommended",
    week: 3,
    category: "financial",
    officialLink: "https://www.getcalfresh.org",
    states: ["California"],
    requiredDocs: ["doc_i94", "doc_proof_of_address"],
    tips: ["Apply online at getcalfresh.org — takes about 10 minutes", "CFAP covers immigrants who don't qualify for federal SNAP", "Undocumented children and seniors 55+ may qualify", "Benefits loaded monthly onto an EBT card usable at most grocery stores", "Does NOT affect public charge or immigration case"],
    translations: {
      es: { title: "Solicitar CalFresh (Asistencia Alimentaria de California)", description: "CalFresh de California provee asistencia alimentaria a inmigrantes elegibles. El Programa de Asistencia Alimentaria de California (CFAP) también cubre a inmigrantes no elegibles para SNAP federal.", tips: ["Solicita en getcalfresh.org — tarda unos 10 minutos", "CFAP cubre a inmigrantes que no califican para SNAP federal", "Niños indocumentados y adultos mayores de 55+ pueden calificar", "Beneficios cargados mensualmente en una tarjeta EBT", "NO afecta la carga pública ni tu caso migratorio"] },
      zh: { title: "申请CalFresh（加州食品援助）", description: "加州的CalFresh为符合条件的移民提供食品援助。加州食品援助计划(CFAP)也覆盖不符合联邦SNAP条件的移民。", tips: ["在getcalfresh.org在线申请 — 约10分钟完成", "CFAP覆盖不符合联邦SNAP条件的移民", "无证件儿童和55岁以上老人可能符合条件", "每月将福利存入EBT卡", "不影响公共负担或移民案件"] },
      hi: { title: "CalFresh के लिए आवेदन करें (कैलिफोर्निया खाद्य सहायता)", description: "कैलिफोर्निया का CalFresh पात्र अप्रवासियों को खाद्य सहायता प्रदान करता है।", tips: ["getcalfresh.org पर ऑनलाइन आवेदन करें — लगभग 10 मिनट लगते हैं", "CFAP उन अप्रवासियों को कवर करता है जो संघीय SNAP के लिए पात्र नहीं हैं", "बिना दस्तावेज वाले बच्चे और 55+ वरिष्ठ नागरिक पात्र हो सकते हैं", "लाभ मासिक रूप से EBT कार्ड पर लोड होते हैं", "सार्वजनिक भार या आव्रजन मामले को प्रभावित नहीं करता"] },
      ar: { title: "التقدم للحصول على CalFresh (مساعدة غذائية كاليفورنية)", description: "يوفر CalFresh في كاليفورنيا مساعدة غذائية للمهاجرين المؤهلين.", tips: ["تقدم بطلبك على getcalfresh.org — يستغرق نحو 10 دقائق", "يغطي CFAP المهاجرين غير المؤهلين للـ SNAP الفيدرالي", "الأطفال غير الموثقين والكبار 55+ قد يكونون مؤهلين", "تُحمَّل الفوائد شهرياً على بطاقة EBT", "لا يؤثر على العبء العام أو قضيتك الهجرية"] },
      fr: { title: "Faire une demande de CalFresh (Aide alimentaire californienne)", description: "Le CalFresh de Californie fournit une aide alimentaire aux immigrants éligibles.", tips: ["Faites une demande sur getcalfresh.org — environ 10 minutes", "Le CFAP couvre les immigrants non éligibles au SNAP fédéral", "Les enfants sans papiers et les seniors 55+ peuvent être éligibles", "N'affecte pas la charge publique ni votre dossier d'immigration"] },
      pt: { title: "Solicitar CalFresh (Assistência Alimentar da Califórnia)", description: "O CalFresh da Califórnia fornece assistência alimentar a imigrantes elegíveis.", tips: ["Solicite em getcalfresh.org — leva cerca de 10 minutos", "O CFAP cobre imigrantes não elegíveis para o SNAP federal", "Crianças indocumentadas e idosos 55+ podem se qualificar", "Não afeta a carga pública ou seu caso de imigração"] },
      vi: { title: "Đăng Ký CalFresh (Hỗ Trợ Thực Phẩm California)", description: "CalFresh của California cung cấp hỗ trợ thực phẩm cho người nhập cư đủ điều kiện.", tips: ["Đăng ký tại getcalfresh.org — mất khoảng 10 phút", "CFAP bao gồm người nhập cư không đủ điều kiện nhận SNAP liên bang", "Trẻ em không có giấy tờ và người cao tuổi 55+ có thể đủ điều kiện", "Không ảnh hưởng đến gánh nặng công hoặc hồ sơ di trú"] },
      ko: { title: "CalFresh 신청 (캘리포니아 식품 지원)", description: "캘리포니아의 CalFresh는 자격을 갖춘 이민자에게 식품 지원을 제공합니다.", tips: ["getcalfresh.org에서 온라인 신청 — 약 10분 소요", "CFAP는 연방 SNAP 자격이 없는 이민자를 포함합니다", "미등록 아동 및 55세 이상 노인도 자격이 될 수 있습니다", "공공 부담이나 이민 사건에 영향을 미치지 않습니다"] },
      tl: { title: "Mag-apply para sa CalFresh (California Food Assistance)", description: "Ang CalFresh ng California ay nagbibigay ng tulong sa pagkain sa mga karapat-dapat na imigrante.", tips: ["Mag-apply sa getcalfresh.org — mga 10 minuto lamang", "Sinasaklaw ng CFAP ang mga imigrante na hindi karapat-dapat sa federal SNAP", "Ang mga undocumented na bata at matatanda 55+ ay maaaring maging karapat-dapat", "Hindi nakakaapekto sa public charge o immigration case"] },
    },
  },
  {
    key: "ca_ab60_license",
    title: "Get an AB 60 Driver's License (California)",
    description: "California allows immigrants regardless of immigration status to obtain a standard driver's license under AB 60. You do not need an SSN or legal status.",
    urgency: "recommended",
    week: 4,
    category: "identity",
    officialLink: "https://www.dmv.ca.gov/portal/driver-licenses-identification-cards/dl-id-cards-for-californians/ab-60-driver-licenses/",
    states: ["California"],
    requiredDocs: ["doc_passport"],
    tips: ["No SSN or legal immigration status required", "Bring any two identity documents — passport, foreign ID, utility bill, or birth certificate", "Schedule a DMV appointment at dmv.ca.gov — walk-ins have long waits", "Must pass written test (available in 36 languages) and driving test", "AB 60 license cannot be used for federal purposes (flying, federal buildings) — get a REAL ID separately if eligible"],
    translations: {
      es: { title: "Obtener Licencia de Conducir AB 60 (California)", description: "California permite a los inmigrantes sin importar su estatus obtener una licencia de conducir estándar bajo AB 60. No necesitas SSN ni estatus legal.", tips: ["No se requiere SSN ni estatus migratorio legal", "Lleva dos documentos de identidad — pasaporte, ID extranjera, factura de servicios o acta de nacimiento", "Programa una cita en el DMV en dmv.ca.gov", "Debes pasar el examen escrito (disponible en 36 idiomas) y el examen de manejo", "La licencia AB 60 no sirve para propósitos federales — obtén una REAL ID si eres elegible"] },
      zh: { title: "获取AB 60驾照（加州）", description: "加州允许无论移民身份的移民在AB 60下获得标准驾照，无需SSN或合法身份。", tips: ["不需要SSN或合法移民身份", "携带任意两份身份证明文件", "在dmv.ca.gov预约DMV", "需通过笔试（36种语言）和驾驶测试", "AB 60驾照不能用于联邦用途"] },
      hi: { title: "AB 60 ड्राइवर लाइसेंस प्राप्त करें (कैलिफोर्निया)", description: "कैलिफोर्निया AB 60 के तहत आव्रजन स्थिति की परवाह किए बिना मानक ड्राइवर लाइसेंस देता है। SSN या कानूनी स्थिति की जरूरत नहीं।", tips: ["SSN या कानूनी आव्रजन स्थिति की आवश्यकता नहीं", "कोई भी दो पहचान दस्तावेज लाएं", "dmv.ca.gov पर DMV अपॉइंटमेंट शेड्यूल करें", "लिखित परीक्षा (36 भाषाओं में) और ड्राइविंग परीक्षा पास करनी होगी"] },
      ar: { title: "الحصول على رخصة قيادة AB 60 (كاليفورنيا)", description: "تسمح كاليفورنيا للمهاجرين بغض النظر عن وضعهم الهجري بالحصول على رخصة قيادة قياسية بموجب AB 60.", tips: ["لا يشترط وجود SSN أو وضع هجري قانوني", "أحضر أي وثيقتين للهوية", "احجز موعداً في DMV على dmv.ca.gov", "يجب اجتياز اختبار كتابي (بـ 36 لغة) واختبار القيادة"] },
      fr: { title: "Obtenir un Permis de Conduire AB 60 (Californie)", description: "La Californie permet aux immigrants quel que soit leur statut d'obtenir un permis de conduire standard sous AB 60.", tips: ["Aucun SSN ni statut légal requis", "Apportez deux pièces d'identité", "Prenez rendez-vous au DMV sur dmv.ca.gov", "Réussissez l'examen écrit (en 36 langues) et l'examen de conduite"] },
      pt: { title: "Obter Carteira de Motorista AB 60 (Califórnia)", description: "A Califórnia permite que imigrantes independentemente do status obtenham uma carteira de motorista padrão pelo AB 60.", tips: ["Nenhum SSN ou status legal necessário", "Traga quaisquer dois documentos de identidade", "Agende uma consulta no DMV em dmv.ca.gov", "Passe no teste escrito (em 36 idiomas) e no teste de direção"] },
      vi: { title: "Lấy Bằng Lái Xe AB 60 (California)", description: "California cho phép người nhập cư bất kể tình trạng di trú lấy bằng lái xe tiêu chuẩn theo AB 60.", tips: ["Không cần SSN hoặc tình trạng di trú hợp pháp", "Mang theo hai tài liệu nhận dạng bất kỳ", "Đặt lịch hẹn DMV tại dmv.ca.gov", "Phải vượt qua bài kiểm tra viết (36 ngôn ngữ) và bài kiểm tra lái xe"] },
      ko: { title: "AB 60 운전 면허 취득 (캘리포니아)", description: "캘리포니아는 AB 60에 따라 이민 신분에 관계없이 표준 운전 면허를 취득할 수 있습니다.", tips: ["SSN 또는 합법적 이민 신분 불필요", "신분 증명 서류 2개 지참", "dmv.ca.gov에서 DMV 예약", "필기 시험(36개 언어) 및 운전 시험 통과 필요"] },
      tl: { title: "Kumuha ng AB 60 Driver's License (California)", description: "Pinapayagan ng California ang mga imigrante anuman ang immigration status na makakuha ng standard driver's license sa ilalim ng AB 60.", tips: ["Hindi kailangan ng SSN o legal na immigration status", "Magdala ng anumang dalawang dokumento ng pagkakakilanlan", "Mag-schedule ng DMV appointment sa dmv.ca.gov", "Kailangan pumasa sa written test (sa 36 na wika) at driving test"] },
    },
  },
  ...
  {
    key: "az_ahcccs",
    title: "Apply for AHCCCS (Arizona Medicaid)",
    description: "Arizona's AHCCCS program provides free health coverage for eligible immigrants including refugees, asylees, and lawful residents who meet income requirements.",
    urgency: "urgent",
    week: 2,
    category: "health",
    officialLink: "https://www.healthearizonaplus.gov",
    states: ["Arizona"],
    requiredDocs: ["doc_i94", "doc_immigration_documents"],
    tips: ["Apply online at healthearizonaplus.gov", "Refugees and asylees qualify immediately — no 5-year wait", "Refugee Medical Assistance (RMA) covers up to 4 months for newly arrived refugees", "Contact the Arizona Refugee Resettlement Program (DES) for help: (602) 542-6600", "2-1-1 Arizona can help connect you to local application assistors"],
    translations: {
      es: { title: "Solicitar AHCCCS (Medicaid de Arizona)", description: "El programa AHCCCS de Arizona ofrece cobertura médica gratuita para inmigrantes elegibles incluyendo refugiados y residentes legales.", tips: ["Solicita en healthearizonaplus.gov", "Refugiados y asilados califican de inmediato — sin espera de 5 años", "La Asistencia Médica para Refugiados (RMA) cubre hasta 4 meses para recién llegados", "Llama al (602) 542-6600 para obtener ayuda", "2-1-1 Arizona puede conectarte con asistentes locales de solicitudes"] },
      zh: { title: "申请AHCCCS（亚利桑那州医疗补助）", description: "亚利桑那州的AHCCCS项目为难民、庇护者和符合收入要求的合法居民提供免费医疗保险。", tips: ["在healthearizonaplus.gov在线申请", "难民和庇护者立即符合条件 — 无需等待5年", "难民医疗援助(RMA)为新到达的难民提供最多4个月的覆盖", "联系亚利桑那州难民安置计划(DES): (602) 542-6600"] },
      hi: { title: "AHCCCS के लिए आवेदन करें (एरिज़ोना मेडिकेड)", description: "एरिज़ोना का AHCCCS कार्यक्रम शरणार्थियों और पात्र अप्रवासियों को मुफ्त स्वास्थ्य बीमा प्रदान करता है।", tips: ["healthearizonaplus.gov पर ऑनलाइन आवेदन करें", "शरणार्थी और शरण प्राप्त व्यक्ति तुरंत पात्र हैं — 5 साल की प्रतीक्षा नहीं", "शरणार्थी चिकित्सा सहायता (RMA) नए आगमन के लिए 4 महीने तक कवर करती है", "सहायता के लिए (602) 542-6600 पर कॉल करें"] },
      ar: { title: "التقدم للحصول على AHCCCS (ميديكيد أريزونا)", description: "يوفر برنامج AHCCCS في أريزونا تغطية صحية مجانية للاجئين والمقيمين القانونيين المؤهلين.", tips: ["تقدم بطلبك على healthearizonaplus.gov", "اللاجئون وطالبو اللجوء مؤهلون فوراً دون انتظار 5 سنوات", "تغطي مساعدة اللاجئين الطبية (RMA) حتى 4 أشهر", "اتصل بـ (602) 542-6600 للحصول على مساعدة"] },
      fr: { title: "Faire une demande d'AHCCCS (Medicaid de l'Arizona)", description: "Le programme AHCCCS de l'Arizona fournit une couverture santé gratuite aux immigrants éligibles, notamment les réfugiés.", tips: ["Faites une demande sur healthearizonaplus.gov", "Les réfugiés et demandeurs d'asile sont éligibles immédiatement", "L'Aide médicale aux réfugiés (RMA) couvre jusqu'à 4 mois", "Appelez le (602) 542-6600 pour obtenir de l'aide"] },
      pt: { title: "Solicitar AHCCCS (Medicaid do Arizona)", description: "O programa AHCCCS do Arizona fornece cobertura de saúde gratuita para imigrantes elegíveis, incluindo refugiados.", tips: ["Solicite em healthearizonaplus.gov", "Refugiados e asilados se qualificam imediatamente", "A Assistência Médica para Refugiados (RMA) cobre até 4 meses", "Ligue para (602) 542-6600 para obter ajuda"] },
      vi: { title: "Đăng Ký AHCCCS (Medicaid Arizona)", description: "Chương trình AHCCCS của Arizona cung cấp bảo hiểm y tế miễn phí cho người nhập cư đủ điều kiện, bao gồm người tị nạn.", tips: ["Đăng ký tại healthearizonaplus.gov", "Người tị nạn và người tị nạn chính trị đủ điều kiện ngay lập tức", "Hỗ trợ Y tế Người tị nạn (RMA) bao gồm tối đa 4 tháng", "Gọi (602) 542-6600 để được hỗ trợ"] },
      ko: { title: "AHCCCS 신청 (애리조나 메디케이드)", description: "애리조나의 AHCCCS 프로그램은 난민 및 자격을 갖춘 이민자에게 무료 건강 보험을 제공합니다.", tips: ["healthearizonaplus.gov에서 온라인 신청", "난민과 망명자는 즉시 자격 — 5년 대기 없음", "난민 의료 지원(RMA)은 최대 4개월 보장", "도움을 위해 (602) 542-6600으로 전화"] },
      tl: { title: "Mag-apply para sa AHCCCS (Arizona Medicaid)", description: "Ang programa ng AHCCCS ng Arizona ay nagbibigay ng libreng health coverage para sa mga karapat-dapat na imigrante kasama ang mga refugee.", tips: ["Mag-apply sa healthearizonaplus.gov", "Ang mga refugee at asylee ay karapat-dapat kaagad — walang 5-taong paghihintay", "Ang Refugee Medical Assistance (RMA) ay sumasaklaw ng hanggang 4 na buwan", "Tumawag sa (602) 542-6600 para sa tulong"] },
    },
  },
  {
    key: "az_refugee_cash",
    title: "Apply for Refugee Cash Assistance (Arizona)",
    description: "Arizona's Refugee Cash Assistance provides monthly cash benefits for up to 4 months to eligible refugees and newcomers who don't qualify for other cash programs.",
    urgency: "urgent",
    week: 1,
    category: "financial",
    officialLink: "https://des.az.gov/services/basic-needs/refugees-and-immigrants",
    states: ["Arizona"],
    requiredDocs: ["doc_i94", "doc_immigration_documents"],
    tips: ["Available to refugees, asylees, Cuban/Haitian entrants, Afghan and Ukrainian parolees", "Must apply within 30 days of arrival", "Contact your local resettlement agency immediately — they will help you apply", "In Phoenix: (602) 433-2234 | In Tucson: (520) 770-1800", "Also covers TANF-eligible newcomer households with a supplemental payment"],
    translations: {
      es: { title: "Solicitar Asistencia en Efectivo para Refugiados (Arizona)", description: "La Asistencia en Efectivo para Refugiados de Arizona proporciona beneficios mensuales en efectivo por hasta 4 meses para refugiados elegibles.", tips: ["Disponible para refugiados, asilados, entrantes cubanos/haitianos y afganos/ucranianos", "Debes solicitar dentro de los 30 días de llegada", "Contacta tu agencia de reasentamiento local de inmediato", "En Phoenix: (602) 433-2234 | En Tucson: (520) 770-1800"] },
      zh: { title: "申请难民现金援助（亚利桑那州）", description: "亚利桑那州的难民现金援助为符合条件的难民和新移民提供最多4个月的月现金福利。", tips: ["适用于难民、庇护者、古巴/海地入境者和阿富汗/乌克兰假释者", "必须在抵达后30天内申请", "立即联系当地安置机构", "菲尼克斯: (602) 433-2234 | 图森: (520) 770-1800"] },
      hi: { title: "शरणार्थी नकद सहायता के लिए आवेदन करें (एरिज़ोना)", description: "एरिज़ोना की शरणार्थी नकद सहायता पात्र शरणार्थियों को 4 महीने तक मासिक नकद लाभ प्रदान करती है।", tips: ["शरणार्थियों, शरण प्राप्त व्यक्तियों और अफगान/यूक्रेनी पैरोलियों के लिए उपलब्ध", "आगमन के 30 दिनों के भीतर आवेदन करें", "तुरंत स्थानीय पुनर्वास एजेंसी से संपर्क करें", "फीनिक्स: (602) 433-2234 | टक्सन: (520) 770-1800"] },
      ar: { title: "التقدم للحصول على مساعدة نقدية للاجئين (أريزونا)", description: "توفر مساعدة اللاجئين النقدية في أريزونا فوائد نقدية شهرية لمدة 4 أشهر للاجئين المؤهلين.", tips: ["متاح للاجئين وطالبي اللجوء والمقبولين الأفغان والأوكرانيين", "يجب التقدم خلال 30 يوماً من الوصول", "تواصل فوراً مع وكالة الاستيطان المحلية", "فينيكس: (602) 433-2234 | توسون: (520) 770-1800"] },
      fr: { title: "Faire une demande d'Aide en Espèces pour les Réfugiés (Arizona)", description: "L'aide en espèces pour réfugiés de l'Arizona offre des prestations mensuelles jusqu'à 4 mois aux réfugiés éligibles.", tips: ["Disponible pour les réfugiés, demandeurs d'asile, et parolés afghans/ukrainiens", "Faites une demande dans les 30 jours suivant l'arrivée", "Contactez immédiatement votre agence de réinstallation locale"] },
      pt: { title: "Solicitar Assistência em Dinheiro para Refugiados (Arizona)", description: "A Assistência em Dinheiro para Refugiados do Arizona fornece benefícios mensais por até 4 meses para refugiados elegíveis.", tips: ["Disponível para refugiados, asilados e paroles afegãos/ucranianos", "Solicite dentro de 30 dias da chegada", "Entre em contato com sua agência de reassentamento local imediatamente"] },
      vi: { title: "Đăng Ký Hỗ Trợ Tiền Mặt Cho Người Tị Nạn (Arizona)", description: "Hỗ trợ Tiền mặt cho Người tị nạn của Arizona cung cấp phúc lợi tiền mặt hàng tháng tối đa 4 tháng cho người tị nạn đủ điều kiện.", tips: ["Có sẵn cho người tị nạn, người tị nạn chính trị, và người Afghanistan/Ukraine được tạm tha", "Phải nộp đơn trong vòng 30 ngày kể từ khi đến", "Liên hệ ngay với cơ quan tái định cư địa phương"] },
      ko: { title: "난민 현금 지원 신청 (애리조나)", description: "애리조나의 난민 현금 지원은 자격을 갖춘 난민에게 최대 4개월 동안 월별 현금 혜택을 제공합니다.", tips: ["난민, 망명자, 아프간/우크라이나 가석방자에게 적용", "도착 후 30일 이내에 신청해야 함", "즉시 지역 재정착 기관에 연락하세요"] },
      tl: { title: "Mag-apply para sa Refugee Cash Assistance (Arizona)", description: "Ang Refugee Cash Assistance ng Arizona ay nagbibigay ng buwanang cash benefits hanggang 4 na buwan para sa mga karapat-dapat na refugee.", tips: ["Available para sa mga refugee, asylee, at Afghan/Ukrainian parolee", "Kailangan mag-apply sa loob ng 30 araw ng pagdating", "Makipag-ugnayan agad sa iyong lokal na resettlement agency"] },
    },
  },

  // ── TEXAS ─────────────────────────────────────────────────────────────────────
  {
    key: "tx_chip_children",
    title: "Enroll Children in CHIP (Texas)",
    description: "Texas offers CHIP (Children's Health Insurance Program) to children under 19 in low-income families. Refugee and asylee children qualify immediately — no 5-year wait.",
    urgency: "urgent",
    week: 2,
    category: "health",
    officialLink: "https://www.hhs.texas.gov/chip",
    states: ["Texas"],
    requiredDocs: ["doc_i94", "doc_immigration_documents"],
    tips: ["Apply at yourtexasbenefits.com or call 2-1-1", "CHIP covers doctor visits, prescriptions, dental, and vision for children under 19", "Refugee and asylee children qualify immediately with no waiting period", "Low monthly premiums starting around $50/family if income is over 201% FPL", "Undocumented children are NOT eligible for CHIP — contact a navigator for other options"],
    translations: {
      es: { title: "Inscribir Niños en CHIP (Texas)", description: "Texas ofrece CHIP para niños menores de 19 años en familias de bajos ingresos. Los niños refugiados y asilados califican de inmediato.", tips: ["Solicita en yourtexasbenefits.com o llama al 2-1-1", "CHIP cubre visitas médicas, medicamentos, dental y visión para menores de 19", "Niños refugiados y asilados califican inmediatamente sin período de espera", "Primas mensuales bajas desde ~$50/familia si el ingreso supera el 201% del FPL"] },
      zh: { title: "为儿童申请CHIP（德克萨斯州）", description: "德克萨斯州为低收入家庭19岁以下儿童提供CHIP计划。难民和庇护儿童立即符合条件。", tips: ["在yourtexasbenefits.com申请或拨打2-1-1", "CHIP覆盖19岁以下儿童的看诊、药物、牙科和视力", "难民和庇护儿童立即符合条件，无需等待期", "如收入超过联邦贫困线201%，每月保费约$50/家庭"] },
      hi: { title: "बच्चों को CHIP में नामांकित करें (टेक्सास)", description: "टेक्सास कम आय वाले परिवारों में 19 वर्ष से कम उम्र के बच्चों को CHIP प्रदान करता है। शरणार्थी बच्चे तुरंत पात्र हैं।", tips: ["yourtexasbenefits.com पर आवेदन करें या 2-1-1 पर कॉल करें", "CHIP 19 वर्ष से कम उम्र के बच्चों के लिए चिकित्सा, दंत और दृष्टि को कवर करता है", "शरणार्थी और शरण प्राप्त बच्चे बिना प्रतीक्षा के तुरंत पात्र हैं"] },
      ar: { title: "تسجيل الأطفال في CHIP (تكساس)", description: "يوفر تكساس برنامج CHIP للأطفال دون 19 عاماً في الأسر ذات الدخل المنخفض. أطفال اللاجئين وطالبي اللجوء مؤهلون فوراً.", tips: ["تقدم بطلبك على yourtexasbenefits.com أو اتصل بـ 2-1-1", "يغطي CHIP الزيارات الطبية والأدوية والأسنان والبصر للأطفال دون 19", "أطفال اللاجئين وطالبي اللجوء مؤهلون فوراً دون فترة انتظار"] },
      fr: { title: "Inscrire les Enfants au CHIP (Texas)", description: "Le Texas offre le CHIP aux enfants de moins de 19 ans dans les familles à faible revenu. Les enfants réfugiés et demandeurs d'asile sont éligibles immédiatement.", tips: ["Faites une demande sur yourtexasbenefits.com ou appelez le 2-1-1", "Le CHIP couvre les visites médicales, médicaments, dentaire et vision pour les moins de 19 ans", "Les enfants réfugiés sont éligibles immédiatement sans délai d'attente"] },
      pt: { title: "Inscrever Crianças no CHIP (Texas)", description: "O Texas oferece CHIP para crianças menores de 19 anos em famílias de baixa renda. Crianças refugiadas e asiladas se qualificam imediatamente.", tips: ["Solicite em yourtexasbenefits.com ou ligue para 2-1-1", "O CHIP cobre consultas médicas, medicamentos, dentista e visão para menores de 19", "Crianças refugiadas se qualificam imediatamente sem período de espera"] },
      vi: { title: "Đăng Ký CHIP cho Trẻ Em (Texas)", description: "Texas cung cấp CHIP cho trẻ em dưới 19 tuổi trong các gia đình thu nhập thấp. Trẻ em tị nạn và xin tị nạn đủ điều kiện ngay lập tức.", tips: ["Đăng ký tại yourtexasbenefits.com hoặc gọi 2-1-1", "CHIP bao gồm khám bệnh, thuốc, nha khoa và nhãn khoa cho trẻ dưới 19 tuổi", "Trẻ em tị nạn đủ điều kiện ngay lập tức không cần thời gian chờ"] },
      ko: { title: "어린이 CHIP 등록 (텍사스)", description: "텍사스는 저소득 가정의 19세 미만 어린이에게 CHIP을 제공합니다. 난민 어린이는 즉시 자격이 됩니다.", tips: ["yourtexasbenefits.com에서 신청 또는 2-1-1 전화", "CHIP은 19세 미만 어린이의 진료, 약, 치과, 시력을 보장합니다", "난민 어린이는 대기 기간 없이 즉시 자격이 됩니다"] },
      tl: { title: "Mag-enroll ng mga Bata sa CHIP (Texas)", description: "Nag-aalok ang Texas ng CHIP sa mga batang wala pang 19 taong gulang sa mga pamilyang may mababang kita. Ang mga refugee at asylee na bata ay karapat-dapat kaagad.", tips: ["Mag-apply sa yourtexasbenefits.com o tumawag sa 2-1-1", "Sinasaklaw ng CHIP ang pagbisita sa doktor, gamot, dentista, at mata para sa mga wala pang 19", "Ang mga refugee na bata ay karapat-dapat kaagad nang walang panahon ng paghihintay"] },
    },
  },
  {
    key: "tx_workforce",
    title: "Register with Texas Workforce Commission",
    description: "Texas Workforce Commission (TWC) connects immigrants with jobs, job training, English classes, and career services. Refugees can access services for up to 5 years after arrival.",
    urgency: "recommended",
    week: 3,
    category: "employment",
    officialLink: "https://www.twc.texas.gov/",
    states: ["Texas"],
    tips: ["Find your local workforce center at twc.texas.gov/jobseekers/find-a-workforce-center", "Free job search assistance, resume help, and interview prep", "English as a Second Language (ESL) classes often available at no cost", "Refugees can access services for 5 years from arrival date", "Vocational training programs available with financial support"],
    translations: {
      es: { title: "Registrarse en la Comisión de Fuerza Laboral de Texas", description: "La Comisión de Fuerza Laboral de Texas (TWC) conecta a los inmigrantes con empleos, capacitación y servicios de carrera. Los refugiados pueden acceder a servicios por hasta 5 años.", tips: ["Encuentra tu centro de fuerza laboral local en twc.texas.gov", "Asistencia gratuita para búsqueda de empleo, currículum y preparación de entrevistas", "Clases de inglés (ESL) generalmente disponibles sin costo", "Los refugiados pueden acceder a servicios por 5 años desde la fecha de llegada"] },
      zh: { title: "在德克萨斯州劳动委员会注册", description: "德克萨斯州劳动委员会(TWC)为移民提供就业、培训和职业服务。难民可在抵达后5年内获得服务。", tips: ["在twc.texas.gov查找当地劳动力中心", "免费求职援助、简历帮助和面试准备", "英语(ESL)课程通常免费", "难民可在抵达后5年内获得服务"] },
      hi: { title: "टेक्सास वर्कफोर्स कमीशन के साथ पंजीकरण करें", description: "टेक्सास वर्कफोर्स कमीशन (TWC) अप्रवासियों को नौकरी, प्रशिक्षण और करियर सेवाओं से जोड़ता है।", tips: ["twc.texas.gov पर अपना स्थानीय वर्कफोर्स केंद्र खोजें", "मुफ्त नौकरी खोज सहायता, रेज्यूमे सहायता और साक्षात्कार तैयारी", "अंग्रेजी (ESL) कक्षाएं आमतौर पर निःशुल्क उपलब्ध", "शरणार्थी आगमन की तारीख से 5 साल तक सेवाओं तक पहुंच सकते हैं"] },
      ar: { title: "التسجيل في لجنة القوى العاملة بتكساس", description: "تربط لجنة القوى العاملة في تكساس (TWC) المهاجرين بالوظائف والتدريب وخدمات المسيرة المهنية.", tips: ["ابحث عن مركز القوى العاملة المحلي على twc.texas.gov", "مساعدة مجانية في البحث عن عمل وإعداد السيرة الذاتية والمقابلات", "دروس الإنجليزية كلغة ثانية متاحة عادةً مجاناً", "يمكن للاجئين الوصول إلى الخدمات لمدة 5 سنوات"] },
      fr: { title: "S'inscrire à la Commission de la Main-d'œuvre du Texas", description: "La Commission de la main-d'œuvre du Texas (TWC) connecte les immigrants à des emplois, des formations et des services de carrière.", tips: ["Trouvez votre centre de travail local sur twc.texas.gov", "Aide gratuite pour la recherche d'emploi, CV et entretiens", "Cours d'anglais (ESL) généralement disponibles gratuitement", "Les réfugiés peuvent accéder aux services pendant 5 ans"] },
      pt: { title: "Registrar-se na Comissão de Força de Trabalho do Texas", description: "A Comissão de Força de Trabalho do Texas (TWC) conecta imigrantes a empregos, treinamento e serviços de carreira.", tips: ["Encontre seu centro de trabalho local em twc.texas.gov", "Assistência gratuita para busca de emprego, currículo e entrevistas", "Aulas de inglês (ESL) geralmente disponíveis gratuitamente", "Refugiados podem acessar serviços por 5 anos"] },
      vi: { title: "Đăng Ký với Ủy Ban Lực Lượng Lao Động Texas", description: "Ủy ban Lực lượng Lao động Texas (TWC) kết nối người nhập cư với việc làm, đào tạo và dịch vụ nghề nghiệp.", tips: ["Tìm trung tâm lực lượng lao động địa phương tại twc.texas.gov", "Hỗ trợ tìm việc, viết CV và phỏng vấn miễn phí", "Lớp tiếng Anh (ESL) thường miễn phí", "Người tị nạn có thể truy cập dịch vụ trong 5 năm"] },
      ko: { title: "텍사스 노동 위원회에 등록", description: "텍사스 노동 위원회(TWC)는 이민자를 취업, 직업 훈련 및 경력 서비스와 연결합니다.", tips: ["twc.texas.gov에서 지역 노동력 센터 찾기", "무료 구직 지원, 이력서 도움 및 면접 준비", "영어(ESL) 수업 보통 무료 제공", "난민은 도착일로부터 5년간 서비스 이용 가능"] },
      tl: { title: "Mag-register sa Texas Workforce Commission", description: "Ikinokonekta ng Texas Workforce Commission (TWC) ang mga imigrante sa mga trabaho, pagsasanay, at mga serbisyo sa karera.", tips: ["Hanapin ang iyong lokal na workforce center sa twc.texas.gov", "Libreng tulong sa paghahanap ng trabaho, resume, at paghahanda sa panayam", "Ang mga klase ng English (ESL) ay karaniwang libre", "Ang mga refugee ay maaaring ma-access ang mga serbisyo sa loob ng 5 taon"] },
    },
  },
];
